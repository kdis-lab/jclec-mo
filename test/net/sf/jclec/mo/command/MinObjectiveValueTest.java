...
/**
 * Tests for the command that calculates the minimum objective values.
 * 
 * <p>HISTORY:
 * <ul>
...
public class MinObjectiveValueTest extends CommandTest {

	/* Properties */
	
	protected MinObjectiveValue command = new MinObjectiveValue();
	...
	/**
	 * Check that the given minimum value for each objective is correct.
	 * */
	@Test
	public void testMinimumValueOfObjectives(){
		
		// Check objective 0
		this.command.setPopulation(this.population);
		this.command.setObjectiveIndex(0);
		this.command.execute();
		double result = this.command.getMinValue();
		assertTrue(result == 0.0);
		
		// Check objective 1
		this.command.setObjectiveIndex(1);
		this.command.execute();
		result = this.command.getMinValue();
		assertTrue(result == 0.0);
	}
	 ...
	 * */
	@Test
	public void testMinimumValueOfObjectivesOneIndividual(){
