...
/**
 * Tests for the command that counts the number of infeasible solutions
...
public class InfeasibleCounterTest extends CommandTest{

	/* Properties */
	
	protected InfeasibleCounter command = new InfeasibleCounter();
	...
	public void testResultPopulationIsNull(){
		...
		int result = this.command.getNumberInfeasibleSolutions();
		assertTrue(result == 0);
	}
