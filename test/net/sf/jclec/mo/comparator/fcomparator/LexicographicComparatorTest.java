...
/**
 * Tests for the lexicographic comparator.
 * 
 * <p>HISTORY:
 * <ul>
...
public class LexicographicComparatorTest {
	 ...
	 * functions than the second individual, then the result should be <code>1.0</code>.
	 * */
	@Test
	public void testFirstIndividualBetterThanSecondIndividualAllObjectives(){
		...
		LexicographicComparator comparator = new LexicographicComparator((Comparator<IFitness>[])components);
	 ...
	 * */
	@Test
	public void testFirstIndividualBetterThanSecondIndividualSecondObjective(){
	 ...
	 * for all the objective functions than the second individual, then result should be <code>1.0</code>.
	 * */
	@Test
	...
	/**
	 * Assuming a minimization problem, if the first individual has greater or equal objective values 
	 * for all the objective functions than the second individual, then the result should be <code>1.0</code>.
	 * */
	@Test
	public void testSecondIndividualBetterThanFirstIndividualSecondObjective(){
	...
	/**
	 * If both individual have the same objective values,
