...
/**
 * Tests for the Relative Progress (RP) indicator.
 * 
 * <p>HISTORY:
 * <ul>
...
public class RelativeProgressTest {
	...
	protected RelativeProgress indicator = new RelativeProgress();
	...
	public void testEmptyFrontsResultInvalid() {
		double [][] front_g1 = new double [][]{};
		double [][] front_gt = new double [][]{};
		double [][] trueFront = new double [][]{};
		this.indicator.setFront(front_g1);
		this.indicator.setSecondFront(front_gt);
		this.indicator.setTrueFront(trueFront);
	...
	public void testEqualFrontsResultEqualsZero(){
		...
		this.indicator.setTrueFront(front);
		this.indicator.calculate();
		double result = this.indicator.getResult();
