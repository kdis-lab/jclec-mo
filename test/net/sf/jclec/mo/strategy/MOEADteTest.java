...
public class MOEADteTest extends MOStrategyTest {

	/* Properties */

	protected MOEADte moeadStrategy = new MOEADte();
	 ...
	 * is not null. An archive containing the non-dominated solutions
	 * should be created.
	 * */
	@Test
	...
	/**
	 * Test that, if the configuration states that the archive should not be used,
	 * then the result returned by the initialization phase is null (the archive 
	 * is not created).
	 * */
	@Test
	 ...
	 * as parents is equal to the population size x 2.
	 * */
	@Test
