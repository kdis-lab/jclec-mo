...
/**
 * A variant of the OMOPSO strategy for problems with constraints. It creates specialized commands
 * that consider the existence of feasible and infeasible solutions. The comparator is also redefined.
 *  
 * <p>HISTORY:
 * <ul>
 ...
 * @see OMOPSO
 * */
public class ConstrainedOMOPSO extends OMOPSO {
	...
	/** Serial ID */
	private static final long serialVersionUID = -1010903195379215339L;
