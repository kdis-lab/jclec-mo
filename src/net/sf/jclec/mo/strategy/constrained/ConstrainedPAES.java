...
import net.sf.jclec.mo.strategy.PAES;

/**
 * A PAES strategy for problems with constraints. This class configures
 ...
 * @see IConstrained
 * */
public class ConstrainedPAES extends PAES {
	...
	/** Serial ID */
	private static final long serialVersionUID = 7063679010004980182L;
