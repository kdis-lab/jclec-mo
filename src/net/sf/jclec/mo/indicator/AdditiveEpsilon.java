...
/**
 * The additive epsilon indicator (I_e+) considers the amount by which 
 * a Pareto set should be translated in order to dominate the other Pareto set.
...
public class AdditiveEpsilon extends BinaryIndicator {
	...
	/** Serial ID */
	private static final long serialVersionUID = 9118211781710446766L;
	 ...
	 * */
	public AdditiveEpsilon(List<IIndividual> paretoSet1, List<IIndividual> paretoSet2) {
	 ...
	 * */
	public AdditiveEpsilon(List<IIndividual> paretoFront1, String paretoFront2FileName) {
		super(paretoFront1, paretoFront2FileName, true, true);
	}
	 ...
	 * @param paretoSet2 The second Pareto set.
	 * */
	public AdditiveEpsilon(String paretoFront1FileName, List<IIndividual> paretoSet2) {
		super(paretoFront1FileName, paretoSet2, true, true);
	}
	 ...
	 * @param paretoFront2FileName Name of the file that contains the second Pareto front.
	 * */
	public AdditiveEpsilon(String paretoFront1FileName, String paretoFront2FileName) {
	...
	/**
	 * Maximum epsilon value. It is the maximum distance
	 * by which solution1 has to be moved to dominates solution2
