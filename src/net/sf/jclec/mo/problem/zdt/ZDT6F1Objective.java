...
/**
 * F1 function of ZDT6 optimization problem. For a definition of the ZDT6 problem, see:
 *  
 ...
 *  
 * <p>URL: {@link http://people.ee.ethz.ch/~sop/download/supplementary/testproblems/zdt6/</p>
 *
 * <p>HISTORY:
 * <ul>
 ...
 * @see Objective
 * */
public class ZDT6F1Objective extends Objective {
	...
	public IFitness evaluate(IIndividual solution) {
		...
		if(solution instanceof RealArrayIndividual){
			x1 = ((RealArrayIndividual) solution).getGenotype()[0];
			f = 1- Math.exp(-4*x1)*Math.pow(Math.sin(6*Math.PI*x1),6);
