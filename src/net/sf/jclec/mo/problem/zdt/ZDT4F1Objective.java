...
/**
 * F1 function of ZDT4 optimization problem. For a definition of the ZDT4 problem, see:
 *  
 ...
 * @see Objective
 * */
public class ZDT4F1Objective extends Objective {
	...
	public IFitness evaluate(IIndividual solution) {
		...
		if(solution instanceof RealArrayIndividual){
			f = ((RealArrayIndividual) solution).getGenotype()[0];
