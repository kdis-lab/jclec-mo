...
/**
 * Parallel evaluator for the multiobjective knapsack problem. It
 ...
 * */
public class MOKnapsackParallelEvaluator extends MOParallelEvaluator {
	...
	/** Serial ID */
	private static final long serialVersionUID = -3161178254083125131L;

	/** Matrix of profits, where each row stores the profits 
	 * of the items regarding a different knapsack */
	 ...
	 * Empty constructor.
	 * */
	public MOKnapsackParallelEvaluator(){
		super();
	}
