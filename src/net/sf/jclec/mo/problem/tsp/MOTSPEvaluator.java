...
/**
 * Evaluator for the multiobjective Travelling Salesman Problem (TSP). It
 ...
 * of cities. Nevertheless, this class can be used as a basis for other kind of data (e.g. matrix of cost), without
 ...
 * @see MOTSPObjective
 * */
public class MOTSPEvaluator extends MOEvaluator {
	...
	/**
	 * {@inheritDoc}
	 * <p>A specific parameter of this class is:
	 * <ul>
