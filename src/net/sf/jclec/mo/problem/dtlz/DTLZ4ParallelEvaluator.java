...
/**
 * Parallel evaluator for DTLZ4 optimization problem. For a definition of the DTLZ4 problem, see:
 *  
 ...
 * @see DTLZ4Objective
 * */
public class DTLZ4ParallelEvaluator extends MOParallelEvaluator {
	...
	/** Serial ID */
	private static final long serialVersionUID = 3957250006405828707L;
	 ...
	 * <ul>
	 * 	<li>alpha (<code>integer</code>): The alpha parameter of DTLZ functions. 100 by default.</li>
	 * </ul>
	 * </p>
	 * */
	@Override
	public void configure(Configuration settings) {
		...
		int alpha = settings.getInt("alpha",100);

		// Set the number of objectives
		int numberOfObjs = this.objectives.size();
		int i=0;
		for(Objective obj: this.objectives){
			if(obj instanceof DTLZ4Objective){
				((DTLZ4Objective)obj).setNumberOfObjectives(numberOfObjs);
				((DTLZ4Objective)obj).setAlpha(alpha);
				((DTLZ4Objective)obj).setIndex(i);
				i++;
			}
			else{
				throw new IllegalArgumentException("Objective class should be a DTLZ4Objective");
			}
		}
	}
