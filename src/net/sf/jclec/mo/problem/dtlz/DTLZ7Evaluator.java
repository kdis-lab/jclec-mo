...
/**
 * Evaluator for DTLZ7 optimization problem. For a definition of the DTLZ7 problem, see:
 *  
 ...
 * @see DTLZ7Objective
 * */
public class DTLZ7Evaluator extends MOEvaluator {
	...
	public void configure(Configuration settings) {
		...
		for(Objective obj: this.objectives){
			if(obj instanceof DTLZ7Objective){
				...
				throw new IllegalArgumentException("Objective class should be DTLZ7Objective");
			}
		}
	}
