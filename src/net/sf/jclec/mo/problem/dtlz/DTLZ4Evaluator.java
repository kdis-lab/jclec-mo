...
/**
 * Evaluator for DTLZ4 optimization problem. For a definition of the DTLZ4 problem, see:
 *  
 ...
 * @see DTLZ4Objective
 * */
public class DTLZ4Evaluator extends MOEvaluator {
	...
	public void configure(Configuration settings) {
		...
		for(Objective obj: this.objectives){
			if(obj instanceof DTLZ4Objective){
				...
				throw new IllegalArgumentException("Objective class should be DTLZ4Objective");
			}
		}
	}
