...
/**
 * Parallel evaluator for DTLZ5 optimization problem. For a definition of the DTLZ5 problem, see:
 *  
...
public class DTLZ5ParallelEvaluator extends MOParallelEvaluator {
	...
	/** Serial ID */
	private static final long serialVersionUID = 7761200146670809997L;
	...
	public void configure(Configuration settings) {
		...
		for(Objective obj: this.objectives){
			if(obj instanceof DTLZ5Objective){
				((DTLZ5Objective)obj).setNumberOfObjectives(numberOfObjs);
				((DTLZ5Objective)obj).setIndex(i);
				i++;
			}
			else{
				throw new IllegalArgumentException("Objective class should be DTLZ5Objective");
			}
		}
	}
