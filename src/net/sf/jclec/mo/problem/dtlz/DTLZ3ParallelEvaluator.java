...
/**
 * Parallel evaluator for DTLZ3 optimization problem. For a definition of the DTLZ3 problem, see:
 *  
 ...
 * @see DTLZ3Objective
 * */
public class DTLZ3ParallelEvaluator extends MOParallelEvaluator {
	...
	/** Serial ID */
	private static final long serialVersionUID = -3080364849011561005L;
	...
	public void configure(Configuration settings) {
		...
		for(Objective obj: this.objectives){
			if(obj instanceof DTLZ3Objective){
				((DTLZ3Objective)obj).setNumberOfObjectives(numberOfObjs);
				((DTLZ3Objective)obj).setIndex(i);
				i++;
			}
			else{
				throw new IllegalArgumentException("Objective class should be DTLZ3Objective");
			}
		}
	}
