...
/**
 * Parallel evaluator for DTLZ2 optimization problem. For a definition of the DTLZ2 problem, see:
 *  
 ...
 * 
 * <p>URL: {@link http://people.ee.ethz.ch/~sop/download/supplementary/testproblems/dtlz2/}</p>
 * 
 * <p>HISTORY:
 * <ul>
 ...
 * @see DTLZ2Objective
 * */
public class DTLZ2ParallelEvaluator extends MOParallelEvaluator {
	...
	/** Serial ID */
	private static final long serialVersionUID = -3926650345669450088L;
	...
	public void configure(Configuration settings) {
		...
		for(Objective obj: this.objectives){
			if(obj instanceof DTLZ2Objective){
				((DTLZ2Objective)obj).setNumberOfObjectives(numberOfObjs);
				((DTLZ2Objective)obj).setIndex(i);
				i++;
			}
			else{
				throw new IllegalArgumentException("Objective class should be DTLZ2Objective");
			}
		}
	}
