...
import net.sf.jclec.mo.strategy.OMOPSO;
import net.sf.jclec.mo.strategy.util.Hypercube;

/**
 * Additional properties of a solution for the OMOPSO strategy.
 *  
 * <p>HISTORY:
 * <ul>
...
public class OMOPSOMOFitness extends MOFitness implements IHypercubeMOFitness,ICrowdingDistanceMOFitness {
	...
	/** Serial ID */
	private static final long serialVersionUID = -4419289730401381261L;

	/** Crowding distance */
	protected double crowdingDistance;

	/** Hypercube */
	protected Hypercube hypercube;
	 ...
	 * */
	public OMOPSOMOFitness(MOFitness fitness){
	...
	public IFitness copy() {
		...
		OMOPSOMOFitness result = new OMOPSOMOFitness();
	...
	public boolean equals(Object oth) {
		...
		// Check fitness type
		if (oth instanceof OMOPSOMOFitness) {

			OMOPSOMOFitness coth = (OMOPSOMOFitness) oth;
			...
			eb.append(this.hypercube, coth.hypercube);
