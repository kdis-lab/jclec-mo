...
/**
 * Additional properties of a solution for the PAES strategy.
 *  
 * <p>HISTORY:
 * <ul>
 ...
 * @see PAES
 */
public class PAESMOFitness extends MOFitness implements IPAESMOFitness{
	...
	/** Serial ID */
	private static final long serialVersionUID = -3671138885152478042L;
	 ...
	 * @param dominance The dominance score.
	 * */
	public PAESMOFitness(MOFitness fitness, int location, int dominance) {
	...
	public IFitness copy() {
		...
		PAESMOFitness result = new PAESMOFitness();
		...
		// Add the PAES properties
		result.setLocation(this.location);
		result.setDominanceScore(this.dominance);
	...
	public boolean equals(Object oth) {
		...
		// Check fitness type
		if (oth instanceof PAESMOFitness) {
			
			PAESMOFitness coth = (PAESMOFitness) oth;
			
			// Compare the specific properties
			EqualsBuilder eb = new EqualsBuilder();
			eb.append(this.getValue(), coth.getValue());
			eb.append(this.getLocation(), coth.getLocation());
			eb.append(this.getDominanceScore(), coth.getDominanceScore());
	...
	public String toString() {
		...
		tsb.append("location", this.location);
		tsb.append("dominance score", this.dominance);
		return tsb.toString();
	}
}
