...
/**
 * Multi-objective Genetic Programming (GP) Algorithm.
 * The current implementation defines the same iterative process of a GA, 
 * where offspring are created applying recombination and mutation operators 
 * with a specific probability. 
 * This class can be an extension point for developers that need another kind 
 * of GP operators like permutation, editing or encapsulation.
 * 
 * <p>HISTORY:
 * <ul>
 ...
 * @see MOECAlgorithm
 * */
public class MOGPAlgorithm extends MOECAlgorithm {
	 ...
	 * @param recombinator The operator that has to be set.
	 */
	 ...
	 * @param mutator The operator that has to be set.
	 */
	...
	/**
	 * {@inheritDoc}
	 * <p>In GP, offspring are created by executing 
	 * a crossover and a mutator.</p>
	 * */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * <p>Specific parameters for <code>MOGPAlgorithm</code>:
	 * <ul>
